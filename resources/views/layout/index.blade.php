...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <!-- bg-gradient-primary -->
        <!-- Sidebar -->
        <ul class="navbar-nav sidebar sidebar-dark accordion"  style="background-color: #172b4c;;" id="accordionSidebar">
    ...
    -->
        ...
        <li class="nav-item dropdown no-arrow">
            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Tb Arya</span>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright Direktorat Jendral Pendidikan TInggi, Riset, dan Teknologi</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
